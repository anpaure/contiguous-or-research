#!/usr/bin/env python3
"""Replay an allowed-row emit-all catalogue, including frozen masks."""
...
def main():
    ...
    assert status_counts["frozen"] == report["regenerated_frozen_target_masks"]
    ...
    print(json.dumps({
        ...
        "frozen_records": status_counts["frozen"],
        ...
        "scope": (
            "literal replay of every emitted mask/witness, with the C++ "
            "frozen/new status vocabulary; enumeration completeness follows "
            "from the anchored symbolic theorem"
        ),
