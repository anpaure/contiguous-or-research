...
**Mathematical state:** 2026-09-06. This self-contained proof document records
the exact finite theorem and the shortest live routes to
\[
...
- **[I]** A.7 gives the full-cube bound
  ...
  improve substantially on A.5B; coefficient one remains open.
...
- **[O]** full-cube coefficient one and \(\nu(17)=B(17)\).

There are three conditional coefficient-one compiler branches:
...
far-rank repair. No new finite optimum or coefficient-one claim follows.
...
Unconditionally, A.7 gives the full-cube upper coefficient
\(c_9<1.18071\). A.6 proves a \(2/\sqrt e\) floor for the designated
...
| full coefficient one | [O] | no coefficient-one construction |
...
external data, conditional hypotheses, stopped-event formulations, rank-depth
scope, and [O] status until a literal full-cube word passes OR analysis.
...
\(\nu(k)\ge(2/\sqrt e-o(1))W(k)\); coefficient one remains open.
...
here; the relaxed selectors and full coefficient one remain [O].
