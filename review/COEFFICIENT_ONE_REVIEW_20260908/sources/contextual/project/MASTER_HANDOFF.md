...
**Mathematical state and research record:** 2026-09-08. This document preserves
the self-contained finite and conditional proofs and records the September 8
coefficient improvements and proposed PBBS proof in Section 9. The target is
\[
...
- **[P]** The new PBBS manuscript claims
  ...
  in those reviews; it remains a proposed resolution.
...
- **Comparison:** \(1.177987\) and the proposed \(1\) are values of the
  **same full-cube leading coefficient**. Coefficient one would strengthen
  the explicit improvement and match the asymptotic lower bound; the
  difference in their current status is verification, not the problem or ranks.
- **[I]+[W]** \(\nu(k)=B(k)\) for \(0\le k\le16\); 2.1 records each decisive
  breakthrough.
- **[I]+[W]/[O]** \(24313=B(17)\le\nu(17)\le25745\).
...
The upper bound is Appendix B's reversed boundary splice of the
external [W] `k=16` witness, with a source-only interval proof.
...
Independently close \(24313\le\nu(17)\le25745\). Witnesses constructed in
...
| \(\nu(k)=B(k),0\le k\le16\) | [I]+[W] | only word bodies external |
| \(k=17\) | [I]+[W]/[O] | \(24313\le\nu(17)\le25745\) |
...
[construction companion](../../../CONSTRUCTION.md)
records the finite steps. The retained actual word at \(k=17\) is still
[the 25,745-letter word](../../../finite_construction/answers/k17_upper25745.word),
with recorded bounds \(24,313\le\nu(17)\le25,745\).
The [remote finite-ledger check](../../essential/project/scratch/PBBS_K17_FINITE_COMPILER_LEDGER_20260908.md)
shows that the current PBBS upper-bound ledger cannot certify an improvement
...
- [Received proof and complete audit record] (historical local link not bundled).
- [Geometry, padding and literal-word audit] (historical local link not bundled).
- [Independent exact mask and numerical verifier; run only on h100] (historical local link not bundled).
...
[COEFFICIENT_ONE_PROOF_20260908.md](../../../MANUSCRIPT.md).
...
* [Exact stationary core law and flux](../../essential/project/scratch/PBBS_STATIONARY_CORE_CLOCK_FLUX_AND_RELAXED_DEPTH_ABUNDANCE_20260908.md).
* [Full growing-depth eligibility and insertion-interface proof](../../essential/project/scratch/PBBS_COMMON_DEEP_BOUNDARY_ELIGIBILITY_BY_GROWING_DEPTH_FLUX_20260908.md).
* [Exact actual multipoint renewal and native-partner proof](../../essential/project/scratch/PBBS_ACTUAL_COMMON_BOUNDARY_SHIFTED_TRIANGLE_RENEWAL_20260908.md).
* [Complete previously audited literal compiler, tail and parity chain](../../essential/project/scratch/PBBS_ABUNDANCE_TO_COEFFICIENT_ONE_VERIFIED_COMPILER_CHAIN_20260908.md).
...
attribution are in
[the finite completion audit] (historical local link not bundled).
