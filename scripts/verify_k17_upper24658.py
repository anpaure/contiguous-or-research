...
This checker verifies the supplied24658 word. It enumerates all
...
def main():
    ...
    full = (1 << 17) - 1
    assert len(word) == 24658, ('incorrect length', len(word))
    ...
    (args.output_directory / 'literal24658_verification.json').write_text(
        json.dumps(report, indent=2) + '\n')
    (args.output_directory / 'literal24658_target_witnesses.json').write_text(
