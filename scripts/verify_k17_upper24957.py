...
This checker verifies the height-adaptive24957 word. It enumerates all
...
def main():
    ...
    full = (1 << 17) - 1
    assert len(word) == 24957, ('incorrect length', len(word))
    ...
    (args.output_directory / 'literal24957_verification.json').write_text(
        json.dumps(report, indent=2) + '\n')
    (args.output_directory / 'literal24957_target_witnesses.json').write_text(
