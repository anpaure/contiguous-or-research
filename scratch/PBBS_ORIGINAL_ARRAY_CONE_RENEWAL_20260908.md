...
1. [Finite-layer incidence fibre](/Users/amir.nuriyev/.codex/worktrees/c69c/problem/research_round1/pbbs_finite_layer_zero_triangle_incidence_fibre.md): on a profile with h>=2S, p_s>2H+1 and p_s>=2(s+1) for s<S, fix the entire profile, all original rows of index at least S, and j. Conditional on F_S=0 and a feasible environment, rows s<S are independent uniform weak compositions of ell_s into p_s-s-1 free coordinates, their s+1 base-triangle coordinates being zero. No lifetime constraint on a free coordinate remains.
...
The new [initial-P-run estimate](/Users/amir.nuriyev/.codex/worktrees/c69c/problem/research_round1/pbbs_initial_p_run_incidence_divergence.md)
