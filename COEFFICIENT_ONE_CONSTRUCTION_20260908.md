...
**Historical construction record.** The numerical17-coordinate intervals
below describe earlier stages. They are superseded by exact equality
through22 in the [current table](answers/README.md), including
`nu(17)=24313`. The [bounds ledger](ASYMPTOTIC_BOUNDS.md) records the current
quantitative asymptotic results and their verification status. This page
preserves the recipes and provenance of the earlier constructions.
...
binary-forest repair reduces that to 24,947. The then-best supplied
...
## 3. Historical implemented constructions at k=17

The verified finite bounds at this historical stage were
