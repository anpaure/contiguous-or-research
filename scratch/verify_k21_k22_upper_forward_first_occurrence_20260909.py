...
HOST = "arboghast"
ROOT = Path("/home/amodo/exact-b-k21-k22-upper-forward-20260909")
INPUTS = (
    (21, 353297,
     "0b166713d18f9ba4d064b07575c17068008954ac808313359c5fd0bf5dfe24d7",
     Path("/home/amodo/k21_upper353297_forward_input.word")),
    (22, 706594,
     "84e7448934c539fcc6c3453ffdb988cef219c263974ba49d876354fd24878b45",
     Path("/home/amodo/k22_upper706594_forward_input.word")),
)
...
def main():
    ...
    report = dict(
        ...
        scope=("Only the two SHA-pinned supplied upper-bound words and their "
               ...
               "no reconstruction of the user's constructor, and no audit of "
               "an unavailable Hall-flow certificate."),
    )
    write_json(ROOT / "k21_k22_forward_complete_certificate.json", report)
    print(json.dumps(dict(status=report["status"],
                          report=str(ROOT / "k21_k22_forward_complete_certificate.json"),
