...
2026-09-08. Consolidated after complete root reading of the probability
proof, the numerical audit and its executed checker. The complete
[independent probability/parity audit](scratch/PBBS_HARMONIC_PERIOD_FINITE_PROBABILITY_AND_EXPLICIT_POINT_NINETY_THREE_RATE_AUDIT_20260908.md)
is retained below, together with references to the
[independently executed exact arithmetic](scratch/HARMONIC_PERIOD_THREE_FINITE_ROWS_AND_INTEGRAL_RATIONAL_CERTIFICATE_20260908.md).
The finite probability/conditioning argument, height moment, harmonic sum,
and numerical domain pass with one formulation correction: **the cutoff z
is an integer at least two**. For a real cutoff, replace M/z by M/floor(z).
All supplied applications already use integer z.

This is the strongest currently recorded error bound on the stated finite
PBBS construction, corridor, particle-return, pruning-fibre and
concentration inputs. Internal proof review and exact finite arithmetic
are not external or formal certification of that dependency chain.
The supplied larger checker suites were not rerun or represented as
independently verified. The separate [24,658-letter word](K17_UPPER24658_VERIFIED_20260908.md)
was checked directly and has no asymptotic premise.
...
The [one-row moment audit](scratch/PBBS_ONE_ROW_PERIOD_MOMENTS_AND_EXPLICIT_N_THREE_HALVES_RATE_20260908.md), §3, proves by reflection and the range comparison that
...
See [the exact Boltzmann/profile audit](scratch/PBBS_AUXILIARY_BOLTZMANN_JOINT_PROFILE_ATOM_INDEPENDENT_AUDIT_20260908.md), §5. The expression Q_r is an upper bound for the inverse probability, not a claim of equality.
...
[the local sharp audit](scratch/PBBS_SHARP_UNIMODAL_NB_AND_DEPTH_INTEGRAL_INDEPENDENT_AUDIT_20260908.md), §§1–2.
...
[the whole-row/tower audit](scratch/PBBS_LOG_GCD_WHOLE_ROW_LAW_AND_SUCCESSIVE_CONDITIONING_AUDIT_20260908.md).
...
The [independent exact arithmetic certificate](scratch/HARMONIC_PERIOD_THREE_FINITE_ROWS_AND_INTEGRAL_RATIONAL_CERTIFICATE_20260908.md), §3, proves
...
[the harmonic arithmetic audit](scratch/HARMONIC_PERIOD_THREE_FINITE_ROWS_AND_INTEGRAL_RATIONAL_CERTIFICATE_20260908.md)
